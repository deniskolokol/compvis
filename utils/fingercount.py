...
def segment(frame, threshold_min=25):
    ...
    ret, thresholded = cv2.threshold(diff,
                                     ...
                                     255,
                                     cv2.THRESH_BINARY)
    contours, hierarhy = cv2.findContours(thresholded.copy(),
                                          cv2.RETR_EXTERNAL,
...
def count_fingers(thresholded, hand_segment):
    ...
    # In theory, the center of the hand is half way between
    # the top and bottom and halfway between left and right.
    cX = (left[0] + right[0]) // 2
    cY = (top[1] + bottom[1]) // 2

    # Find the maximum euclidean distance between the center of the palm
    # and the most extreme points of the convex hull    
    # Calculate the Euclidean Distance between the center of the hand and
    ...
    # This then returns the cut out obtained using the mask
    # on the thresholded hand image.
    ...
    for cnt in contours:
        ...
        # 2. Number of points along the contour does not exceed 25% of
        # the circumference of the circular ROI (otherwise we're counting
        # points off the hand).
    ...
    while True:
        ...
        if num_frames < 60:
            ...
            if hand:
                ...
                # Draws contours aroud real hand in live stream.
